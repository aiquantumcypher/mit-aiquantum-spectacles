...
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_22);
float l9_23=l9_22;
...
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_45);
float l9_46=l9_45;
...
{
float l9_51=l9_2.x;
sc_SoftwareWrapEarly(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_52=l9_51;
float l9_53=l9_2.y;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_54=l9_53;
vec2 l9_55;
float l9_56;
...
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_58=l9_52;
float l9_59=1.0;
sc_ClampUV(l9_58,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_57,l9_59);
float l9_60=l9_58;
float l9_61=l9_59;
bool l9_62;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_63=l9_54;
float l9_64=l9_61;
sc_ClampUV(l9_63,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_62,l9_64);
l9_56=l9_64;
...
#endif
vec2 l9_65=sc_TransformUV(l9_55,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_66=l9_65.x;
float l9_67=l9_56;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_67);
float l9_68=l9_65.y;
float l9_69=l9_67;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_69);
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_72=texture(normalTexArrSC,l9_71,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_73=mix(normalTexBorderColor,l9_72,vec4(l9_70));
}
#else
{
l9_73=l9_72;
...
{
float l9_74=l9_2.x;
sc_SoftwareWrapEarly(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_75=l9_74;
float l9_76=l9_2.y;
sc_SoftwareWrapEarly(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_77=l9_76;
vec2 l9_78;
float l9_79;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_80=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_81=l9_75;
float l9_82=1.0;
sc_ClampUV(l9_81,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_80,l9_82);
float l9_83=l9_81;
float l9_84=l9_82;
bool l9_85;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_85=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_86=l9_77;
float l9_87=l9_84;
sc_ClampUV(l9_86,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_85,l9_87);
l9_79=l9_87;
...
#endif
vec2 l9_88=sc_TransformUV(l9_78,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_89=l9_88.x;
float l9_90=l9_79;
sc_SoftwareWrapLate(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_90);
float l9_91=l9_88.y;
float l9_92=l9_90;
sc_SoftwareWrapLate(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_92);
float l9_93=l9_92;
vec3 l9_94=sc_SamplingCoordsViewToGlobal(vec2(l9_89,l9_91),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_95=texture(normalTex,l9_94.xy,0.0);
vec4 l9_96;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_96=mix(normalTexBorderColor,l9_95,vec4(l9_93));
}
#else
{
l9_96=l9_95;
...
{
float l9_98=l9_2.x;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_99=l9_98;
float l9_100=l9_2.y;
sc_SoftwareWrapEarly(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_101=l9_100;
vec2 l9_102;
float l9_103;
...
{
l9_104=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_104=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_105=l9_99;
float l9_106=1.0;
sc_ClampUV(l9_105,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_104,l9_106);
float l9_107=l9_105;
float l9_108=l9_106;
bool l9_109;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_110=l9_101;
float l9_111=l9_108;
sc_ClampUV(l9_110,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_109,l9_111);
l9_103=l9_111;
...
#endif
vec2 l9_112=sc_TransformUV(l9_102,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_113=l9_112.x;
float l9_114=l9_103;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_114);
float l9_115=l9_112.y;
float l9_116=l9_114;
sc_SoftwareWrapLate(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_116);
float l9_117=l9_116;
vec3 l9_118=sc_SamplingCoordsViewToGlobal(vec2(l9_113,l9_115),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_119=texture(materialParamsTexArrSC,l9_118,0.0);
vec4 l9_120;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_120=mix(materialParamsTexBorderColor,l9_119,vec4(l9_117));
}
#else
{
l9_120=l9_119;
...
{
float l9_121=l9_2.x;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_122=l9_121;
float l9_123=l9_2.y;
sc_SoftwareWrapEarly(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_124=l9_123;
vec2 l9_125;
float l9_126;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_127=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_128=l9_122;
float l9_129=1.0;
sc_ClampUV(l9_128,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_127,l9_129);
float l9_130=l9_128;
float l9_131=l9_129;
bool l9_132;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_132=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_133=l9_124;
float l9_134=l9_131;
sc_ClampUV(l9_133,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_132,l9_134);
l9_126=l9_134;
...
#endif
vec2 l9_135=sc_TransformUV(l9_125,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_136=l9_135.x;
float l9_137=l9_126;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_137);
float l9_138=l9_135.y;
float l9_139=l9_137;
sc_SoftwareWrapLate(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_139);
float l9_140=l9_139;
vec3 l9_141=sc_SamplingCoordsViewToGlobal(vec2(l9_136,l9_138),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_142=texture(materialParamsTex,l9_141.xy,0.0);
vec4 l9_143;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_143=mix(materialParamsTexBorderColor,l9_142,vec4(l9_140));
}
#else
{
l9_143=l9_142;
...
{
l9_144=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_50.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_144=vec3(0.0);
...
#endif
float l9_145=clamp(l9_3.w,0.0,1.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_144)>=(-0.050000001))
{
uvec3 l9_146=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_146.x,l9_146.y,l9_146.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_147=abs(l9_144);
vec3 l9_148=l9_144/vec3(dot(l9_147,vec3(1.0)));
float l9_149=clamp(-l9_148.z,0.0,1.0);
float l9_150=l9_148.x;
float l9_151;
if (l9_150>=0.0)
{
l9_151=l9_149;
...
float l9_152=l9_150+l9_151;
float l9_153=l9_148.y;
float l9_154;
if (l9_153>=0.0)
{
l9_154=l9_149;
...
uvec2 l9_155=uvec2(packHalf2x16(vec2(l9_152,0.0)),packHalf2x16(vec2(l9_153+l9_154,0.0)));
normal_and_more=uvec4(l9_155.x,l9_155.y,normal_and_more.z,normal_and_more.w);
...
{
l9_156=uint(clamp(l9_97.y,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_156|uint((receiverId%32)<<int(10u));
}
else
{
...
float l9_30=l9_29.x;
float l9_31=l9_20;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_31);
float l9_32=l9_29.y;
float l9_33=l9_31;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_33);
float l9_34=l9_33;
...
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_56);
float l9_57=l9_56;
...
{
float l9_62=l9_13.x;
sc_SoftwareWrapEarly(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_63=l9_62;
float l9_64=l9_13.y;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_65=l9_64;
vec2 l9_66;
float l9_67;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_68=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_69=l9_63;
float l9_70=1.0;
sc_ClampUV(l9_69,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_68,l9_70);
float l9_71=l9_69;
float l9_72=l9_70;
bool l9_73;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_74=l9_65;
float l9_75=l9_72;
sc_ClampUV(l9_74,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_73,l9_75);
l9_67=l9_75;
...
#endif
vec2 l9_76=sc_TransformUV(l9_66,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_77=l9_76.x;
float l9_78=l9_67;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_78);
float l9_79=l9_76.y;
float l9_80=l9_78;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_80);
float l9_81=l9_80;
vec3 l9_82=sc_SamplingCoordsViewToGlobal(vec2(l9_77,l9_79),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_83=texture(normalTexArrSC,l9_82,0.0);
vec4 l9_84;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_84=mix(normalTexBorderColor,l9_83,vec4(l9_81));
}
#else
{
l9_84=l9_83;
...
{
float l9_85=l9_13.x;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_86=l9_85;
float l9_87=l9_13.y;
sc_SoftwareWrapEarly(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_88=l9_87;
vec2 l9_89;
float l9_90;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_91=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_91=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_92=l9_86;
float l9_93=1.0;
sc_ClampUV(l9_92,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_91,l9_93);
float l9_94=l9_92;
float l9_95=l9_93;
bool l9_96;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_96=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_96=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_97=l9_88;
float l9_98=l9_95;
sc_ClampUV(l9_97,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_96,l9_98);
l9_90=l9_98;
...
#endif
vec2 l9_99=sc_TransformUV(l9_89,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_100=l9_99.x;
float l9_101=l9_90;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_101);
float l9_102=l9_99.y;
float l9_103=l9_101;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_103);
float l9_104=l9_103;
vec3 l9_105=sc_SamplingCoordsViewToGlobal(vec2(l9_100,l9_102),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_106=texture(normalTex,l9_105.xy,0.0);
vec4 l9_107;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_107=mix(normalTexBorderColor,l9_106,vec4(l9_104));
}
#else
{
l9_107=l9_106;
...
#if (materialParamsTexLayout==2)
{
float l9_109=l9_13.x;
sc_SoftwareWrapEarly(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_110=l9_109;
float l9_111=l9_13.y;
sc_SoftwareWrapEarly(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_112=l9_111;
vec2 l9_113;
float l9_114;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_115=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_115=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_116=l9_110;
float l9_117=1.0;
sc_ClampUV(l9_116,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_115,l9_117);
float l9_118=l9_116;
float l9_119=l9_117;
bool l9_120;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_120=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_121=l9_112;
float l9_122=l9_119;
sc_ClampUV(l9_121,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_120,l9_122);
l9_114=l9_122;
...
#endif
vec2 l9_123=sc_TransformUV(l9_113,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_124=l9_123.x;
float l9_125=l9_114;
sc_SoftwareWrapLate(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_125);
float l9_126=l9_123.y;
float l9_127=l9_125;
sc_SoftwareWrapLate(l9_126,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_127);
float l9_128=l9_127;
vec3 l9_129=sc_SamplingCoordsViewToGlobal(vec2(l9_124,l9_126),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_130=texture(materialParamsTexArrSC,l9_129,0.0);
vec4 l9_131;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_131=mix(materialParamsTexBorderColor,l9_130,vec4(l9_128));
}
#else
{
l9_131=l9_130;
...
#else
{
float l9_132=l9_13.x;
sc_SoftwareWrapEarly(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_133=l9_132;
float l9_134=l9_13.y;
sc_SoftwareWrapEarly(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_135=l9_134;
vec2 l9_136;
float l9_137;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_138=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_139=l9_133;
float l9_140=1.0;
sc_ClampUV(l9_139,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_138,l9_140);
float l9_141=l9_139;
float l9_142=l9_140;
bool l9_143;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_143=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_143=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_144=l9_135;
float l9_145=l9_142;
sc_ClampUV(l9_144,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_143,l9_145);
l9_137=l9_145;
...
#endif
vec2 l9_146=sc_TransformUV(l9_136,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_147=l9_146.x;
float l9_148=l9_137;
sc_SoftwareWrapLate(l9_147,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_148);
float l9_149=l9_146.y;
float l9_150=l9_148;
sc_SoftwareWrapLate(l9_149,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_150);
float l9_151=l9_150;
vec3 l9_152=sc_SamplingCoordsViewToGlobal(vec2(l9_147,l9_149),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_153=texture(materialParamsTex,l9_152.xy,0.0);
vec4 l9_154;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_154=mix(materialParamsTexBorderColor,l9_153,vec4(l9_151));
}
#else
{
l9_154=l9_153;
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_155=mat3(l9_3,l9_1,l9_2)*((l9_61.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_155=vec3(0.0);
...
#endif
float l9_156=clamp(l9_14.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_157=max(l9_14.xyz,vec3(0.0));
vec4 l9_158;
#if (sc_ProjectiveShadowsCaster)
{
l9_158=vec4(l9_157,l9_156);
}
#else
{
l9_158=ngsCalculateLighting(l9_157,l9_156,l9_155,l9_4,l9_5,Port_Emissive_N006,clamp(l9_108.x,0.0,1.0),clamp(l9_108.y,0.0,1.0),clamp(vec3(l9_108.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_159=max(l9_158,vec4(0.0));
if (isProxyMode)
{
vec4 l9_160;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_160,vec4(0.0)));
return;
}
vec4 l9_162;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_164=clamp(l9_159.w*2.0,0.0,1.0);
}
#else
{
float l9_165;
...
{
l9_165=clamp(dot(l9_159.xyz,vec3(l9_159.w)),0.0,1.0);
}
#else
{
float l9_166;
...
#if (sc_BlendMode_Multiply)
{
l9_167=(1.0-dot(l9_159.xyz,vec3(0.33333001)))*l9_159.w;
}
#else
{
float l9_168;
...
{
l9_168=(1.0-clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0))*l9_159.w;
}
#else
{
float l9_169;
#if (sc_BlendMode_ColoredGlass)
{
l9_169=clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0)*l9_159.w;
}
#else
{
float l9_170;
#if (sc_BlendMode_Add)
{
l9_170=clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_171;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_171=clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0)*l9_159.w;
}
#else
{
float l9_172;
...
{
l9_172=dot(l9_159.xyz,vec3(0.33333001))*l9_159.w;
}
#else
{
float l9_173;
#if (sc_BlendMode_Min)
{
l9_173=1.0-clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_174;
#if (sc_BlendMode_Max)
{
l9_174=clamp(dot(l9_159.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_174=1.0;
...
#endif
l9_162=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_159.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_163);
}
#else
{
vec4 l9_175;
...
{
vec3 l9_177=sc_GetFramebufferColor().xyz;
vec3 l9_178=mix(l9_177,definedBlend(l9_177,l9_159.xyz).xyz,vec3(l9_159.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_181=l9_159.w;
l9_180=vec4(mix(vec3(1.0),l9_159.xyz,vec3(l9_181)),l9_181);
}
#else
{
vec4 l9_182;
...
{
float l9_183=l9_159.w;
float l9_184;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_184=clamp(l9_183,0.0,1.0);
}
#else
{
l9_184=l9_183;
...
#endif
l9_182=vec4(l9_159.xyz*l9_184,l9_184);
}
#else
{
l9_182=l9_159;
...
{
l9_187=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_187=vec4(0.0);
...
vec4 l9_189=outputMotionVectorsIfNeeded(varPos,max(l9_188,vec4(0.0)));
vec4 l9_190=clamp(l9_189,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_191=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_191-0.0039215689)),min(1.0,l9_191+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_192=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_192).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_193=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_192).xy);
float l9_194=packValue(l9_193);
int l9_201=int(l9_190.w*255.0);
float l9_202=packValue(l9_201);
sc_writeFragData0(vec4(packValue(l9_193),packValue(l9_193),packValue(l9_193),packValue(l9_193)));
sc_writeFragData1(vec4(l9_194,packValue(l9_193),packValue(l9_193),packValue(l9_193)));
sc_writeFragData2(vec4(l9_202,packValue(l9_201),packValue(l9_201),packValue(l9_201)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_205=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_205).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_210==0)
{
l9_213=texture(sc_OITAlpha0,l9_205);
l9_212=texture(sc_OITDepthLow0,l9_205);
l9_211=texture(sc_OITDepthHigh0,l9_205);
}
else
{
l9_213=vec4(0.0);
...
if (l9_210==1)
{
l9_216=texture(sc_OITAlpha1,l9_205);
l9_215=texture(sc_OITDepthLow1,l9_205);
l9_214=texture(sc_OITDepthHigh1,l9_205);
}
else
{
l9_216=l9_213;
...
if (any(notEqual(l9_214,vec4(0.0)))||any(notEqual(l9_215,vec4(0.0))))
{
int l9_217[8]=l9_206;
unpackValues(l9_214.w,l9_210,l9_217);
unpackValues(l9_214.z,l9_210,l9_217);
unpackValues(l9_214.y,l9_210,l9_217);
unpackValues(l9_214.x,l9_210,l9_217);
unpackValues(l9_215.w,l9_210,l9_217);
unpackValues(l9_215.z,l9_210,l9_217);
unpackValues(l9_215.y,l9_210,l9_217);
unpackValues(l9_215.x,l9_210,l9_217);
int l9_226[8]=l9_207;
unpackValues(l9_216.w,l9_210,l9_226);
unpackValues(l9_216.z,l9_210,l9_226);
unpackValues(l9_216.y,l9_210,l9_226);
unpackValues(l9_216.x,l9_210,l9_226);
}
l9_210++;
continue;
}
...
vec4 l9_231=texture(sc_OITFilteredDepthBoundsTexture,l9_205);
vec2 l9_232=l9_231.xy;
int l9_233;
#if (sc_SkinBonesCount>0)
{
l9_233=encodeDepth(((1.0-l9_231.x)*1000.0)+getDepthOrderingEpsilon(),l9_232);
}
#else
{
l9_233=0;
...
#endif
int l9_234=encodeDepth(viewSpaceDepth(),l9_232);
vec4 l9_235;
l9_235=l9_190*l9_190.w;
vec4 l9_236;
int l9_237=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_237<8)
{
int l9_238=l9_206[l9_237];
int l9_239=l9_234-l9_233;
bool l9_240=l9_238<l9_239;
bool l9_241;
if (l9_240)
{
l9_241=l9_206[l9_237]>0;
}
else
{
l9_241=l9_240;
...
if (l9_241)
{
vec3 l9_242=l9_235.xyz*(1.0-(float(l9_207[l9_237])/255.0));
l9_236=vec4(l9_242.x,l9_242.y,l9_242.z,l9_235.w);
}
else
{
l9_236=l9_235;
...
sc_writeFragData0(l9_190);
}
#endif
}
#else
{
sc_writeFragData0(l9_189);
}
#endif
}
#endif
