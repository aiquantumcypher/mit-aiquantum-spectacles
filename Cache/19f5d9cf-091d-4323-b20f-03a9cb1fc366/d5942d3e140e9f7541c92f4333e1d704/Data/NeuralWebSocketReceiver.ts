...
export class NeuralWebSocketReceiver extends BaseScriptComponent {
    ...
    connectToServer() {
        ...
        try {
            ...
            // Use the CORRECT Spectacles WebSocket API from script component
            this.ws = this.getSceneObject().getComponent("Component.ScriptComponent").remoteServiceModule.createWebSocket(serverUrl);
